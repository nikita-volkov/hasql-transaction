...
{-|
Module      : Paths_hasql_transaction
...
-- at runtime using the environment variable hasql_transaction_bindir.
...
-- environment variable hasql_transaction_libdir.
...
-- using the environment variable hasql_transaction_dynlibdir.
...
-- runtime using the environment variable hasql_transaction_datadir.
...
-- variable hasql_transaction_libexedir.
...
-- using the environment variable hasql_transaction_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/hasql-transaction-1.2.1-inplace"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/hasql-transaction-1.2.1"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/hasql-transaction-1.2.1"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "hasql_transaction_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "hasql_transaction_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "hasql_transaction_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "hasql_transaction_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "hasql_transaction_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "hasql_transaction_sysconfdir") (\_ -> return sysconfdir)
